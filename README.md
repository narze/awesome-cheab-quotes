...
- กฎของโอกาส คือ ไม่สามารถให้ใครได้หลายครั้ง [for life]
- เบื่อแล้วหน้าฝนตอนนี้ฉันสนแต่หน้าเธอ😊 [love]
- คนโง่คนใดสามารถเขียนโค้ดที่คอมพิวเตอร์สามารถเข้าใจได้ [code]
- ซอฟต์แวร์ที่ดีอย่างไวน์ต้องใช้เวลา [code]
- การเขียนโปรแกรมเป็นเรื่องสนุก และการเข้ารหัสก็เช่นกัน อย่างไรก็ตามไม่ควรนำมารวมกัน [code]
